...
final class DemoUser: User {
	...
	*/
	...
	static func prepare(_ database: Database) throws {
			try database.create("demousers") { demoUsers in
				demoUsers.id()
				demoUsers.string("username", optional: true)
				demoUsers.string("password", optional: false)
				demoUsers.string("facebook_id", optional: false)
				demoUsers.string("google_id", optional: false)
				demoUsers.string("api_key_id", optional: false)
			demoUsers.string("api_key_secret", optional: false)
			}
		}
